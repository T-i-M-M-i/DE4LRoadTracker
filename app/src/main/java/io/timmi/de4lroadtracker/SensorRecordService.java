    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        switch (sensorEvent.sensor.getType()) {
            ...
            case Sensor.TYPE_MAGNETIC_FIELD: {
                System.arraycopy( sensorEvent.values, 0, magnetometer,0, 3);
                break;
            }
            ...
            case Sensor.TYPE_LINEAR_ACCELERATION: {
                ...
                sensorEventQueue.add(new DE4LSensorEvent(sensorEvent.accuracy, sensorEvent.sensor, sensorEvent.timestamp, accelrationAxis ));
                break;
            }
        }
